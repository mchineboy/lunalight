...
The flag is displayed unexpanded, so each art row is one screen pixel: the
pennant carries the Earth wire-globe emblem in the top twelve rows, the mast
fills the rest, and the base on row 20 rests on the pad line.
"""
import sys
